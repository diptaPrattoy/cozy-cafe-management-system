...
namespace CAFE_MANAGEMENT_SYSTEM
{
    public partial class CashierOrderForm : UserControl
    {
            ...
            else
            {
                if (connect.State == ConnectionState.Closed)
                {
                    try
                    {
                        connect.Open();
                        float getPrice = 0;
                        string selectOrder = "SELECT * FROM products2 WHERE prod_id = @prodID";
        ...
        {
            using (SqlConnection connect = new SqlConnection(@"Data Source=DIPTA-KARMAKAR\SQLEXPRESS;Initial Catalog=cafe2;Integrated Security=True"))
        ...
        private void cashierOrderForm_type_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (selectedValue != null)
            {
                ...
                try
                {
                    ...
                    {
                        connect.Open();
                        string selectData = $"SELECT * FROM products2 WHERE prod_type = '{selectedValue}' AND prod_status = @status AND date_delete IS NULL";
        ...
        private void cashierOrderForm_productID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (selectedValue != null)
            {
                try
                {
                    ...
                    {
                        connect.Open();
                        string selectData = $"SELECT * FROM products2 WHERE prod_id = '{selectedValue}' AND prod_status = @status AND date_delete IS NULL";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            string headerText = "Cozy Cafe Shop";
